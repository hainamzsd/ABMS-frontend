import { View, Text, SafeAreaView, ScrollView, StyleSheet, Pressable, TextInput } from 'react-native'
            ...
            <SafeAreaView style={{ backgroundColor: theme.background, flex: 1 }}>
                <ScrollView automaticallyAdjustKeyboardInsets={true}>
                    <View style={{ marginHorizontal: 26 }}>
                        <View style={[{ backgroundColor: theme.sub, borderColor: theme.primary }, styles.headerBox]}>
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <Pressable style={styles.inputContainer} onPress={() => setShowStartDate(!showStartDate)} >
                                <TextInput
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <Pressable style={styles.inputContainer} onPress={() => setShowEndDate(!showEndDate)} >
                                <TextInput
                                    placeholder={t("Choose date")}
                                    editable={false}
...
const styles = StyleSheet.create({
    headerBox: {
        marginTop: 20, borderWidth: 2, padding: 15,
        borderRadius: 10,
        flexDirection: 'row',
        flexWrap: 'wrap',
    },
