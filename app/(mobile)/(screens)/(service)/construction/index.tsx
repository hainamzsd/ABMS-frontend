    ...
    const data = [
      {
        ...
        path: "/(mobile)/(screens)/(service)/construction/constructionRegisterScreen",
        icon: <Hammer color={"black"} strokeWidth={1.5}></Hammer>,
      },
      {
        serviceName: t("Request list"),
        path: "/(mobile)/(screens)/(service)/construction/constructionList",
        icon: <Menu color={"black"} strokeWidth={1.5}></Menu>,
      },
    ];
