    ...
    const data = [
      {
        ...
        path: "/(mobile)/(screens)/(service)/visitor/visitorRegisterScreen",
        icon: <User color={"black"} strokeWidth={1.5}></User>,
      },
      {
        serviceName: t("Registered visitor"),
        path: "/(mobile)/(screens)/(service)/visitor/visitorList",
        icon: <UserCheck color={"black"} strokeWidth={1.5}></UserCheck>,
      },
    ];
