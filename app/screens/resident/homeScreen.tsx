...
const HomeScreen = () => {
    return (
        <ScrollView style={{ marginHorizontal: 26 }}>
            ...
            <ScrollView style={{ flexDirection: 'row', marginVertical: 30 }} horizontal={true}>

                <View style={{ marginRight: 36 }}>
                    <Image
                        style={{ width: 236, height: 150, objectFit: 'cover', borderTopLeftRadius: 10, borderTopRightRadius: 10 }}
                        source={{ uri: 'https://i1-vnexpress.vnecdn.net/2024/02/14/IMG8466-1707843798-5567-1707844263.png?w=380&h=228&q=100&dpr=1&fit=crop&s=ynSmE0DDUKKGtxlvbPX8kQ' }}
                    ></Image>
                    <View style={{
                        width: 236, height: 90, backgroundColor: 'white',
                        padding: 10, borderBottomLeftRadius: 10, borderBottomRightRadius: 10,
                    }}>
                        <Text style={{ fontWeight: 'bold' }}>
                            Lorem ipsum dolor sit amet</Text>
                        <Text style={{ fontWeight: '300', fontSize: 12, color: '#9C9C9C', marginTop: 5 }}>
                            13 tháng 2, 2024
                        </Text>
                    </View>
                </View>
