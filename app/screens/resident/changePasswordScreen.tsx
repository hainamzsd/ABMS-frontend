            ...
            <SafeAreaView style={{ backgroundColor: COLORS.background, flex: 1 }}>
                <View style={{ marginHorizontal: 26 }}>
                    ...
                    <View style={{ marginTop: 30 }}>
                        <Text style={{ fontSize: 16 }}>Mật khẩu phải tối thiểu 8 kí tự và bao gồm: chữ hoa, chữ thường, số, kí tự đặc biệt</Text>
                    </View>
                    ...
                    <View style={{ marginTop: 30 }}>
                        ...
                        <TextInput
                            ...
                            style={[styles.input, { borderColor: isOldPasswordValid ? '#CCCCCC' : 'red' }]}
                    ...
                    <View style={{ marginTop: 30 }}>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor={'#9C9C9C'}
                            style={[styles.input, { borderColor: isNewPasswordValid ? '#CCCCCC' : 'red' }]}
                    ...
                    <View style={{ marginTop: 30 }}>
                        ...
                        <TextInput
                            ...
                            placeholderTextColor={'#9C9C9C'}
                            style={[styles.input, { borderColor: isReEnterPasswordValid ? '#CCCCCC' : 'red' }]}
                            onChangeText={setReEnterPassword}
                            value={reEnterPassword}
                            secureTextEntry
                        />
                    </View>
                    {!isReEnterPasswordValid && <Text style={styles.errorText}>Mật khẩu không khớp</Text>}
