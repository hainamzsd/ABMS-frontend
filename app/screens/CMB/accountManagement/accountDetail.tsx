        ...
        <View style={{ flex: 1, paddingHorizontal: 100, paddingVertical: 30, backgroundColor: '#F9FAFB' }}>
            <SafeAreaView>
                <ScrollView>
                    ...
                    onPress={() => 
                        console.log(navigation.canGoBack()) }></Button>
                    <View style={{ marginBottom: 20 }}>
                        <Text style={{ fontWeight: 'bold', fontSize: 20, marginBottom: 5 }}>Thông tin tài khoản</Text>
                        <Text>Thông tin chi tiết tài khoản của lễ tân</Text>
                    </View>
                    <View>
                        <Text style={{ marginBottom: 10, fontWeight: '600', fontSize: 16 }}>Tên</Text>
                        <Input placeholder='Họ và tên' style={{ width: '100%' }}
                        ></Input>

                    </View>
                    <View>
                        <Text style={{ marginBottom: 10, fontWeight: '600', fontSize: 16 }}>Email</Text>
                        <Input placeholder='Email' style={[styles.input, !isValidEmailState && styles.invalid]}
                    ...
                    <View>
                        <Text style={{ marginBottom: 10, fontWeight: '600', fontSize: 16 }}>Số điện thoại</Text>
                        <Input placeholder='Phone' style={[styles.input, !isValidPhoneNumberState && styles.invalid]}
                            keyboardType="phone-pad"
                            value={phoneNumber}
                            onChangeText={handlePhoneChange}></Input>
